...
class ProblemaMatematico:
    def __init__(self):
        ...
        self.y_pos = 0  # Posición Y inicial de las respuestas
    ...
    def generar_problema(self):
        ...
        self.y_pos = 0  # Reiniciar la posición Y al generar un nuevo problema
    ...
    def actualizar(self):
        self.y_pos += 2  # Velocidad de caída de los bloques
        if self.y_pos > ALTO:
...
while corriendo:
    ...
    problema.actualizar()  # Actualizar la posición de las respuestas
